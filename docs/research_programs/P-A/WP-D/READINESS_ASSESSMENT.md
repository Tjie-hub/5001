...
|---|---|---|
| **(a) Count N** | ✅ **Yes, for the covered window** | 194 ticker-events (97 ADD / 97 DELETE); 178 distinct economic events; **12 review-date clusters**; window 2022-08 → 2026-05; sub-counts in [[COVERAGE_REPORT]]. Directly countable from `reconstitution_events.csv`. |
...
2. **A coverage-sufficiency judgment.** The verified window is **~3.75 years / 194 events / 12 clusters (2022-08 → 2026-05)**, not the full ~5 years. This is enough to *compute* N/σ/MDE/power, but whether it is enough to *register on* — versus first closing the residual gaps (2021-H2, 2022-H1, May-2024) for more clusters — is a CRO call. **Current owner status: HOLD** ([[HYP-PA-0001_POWER]] §4a).
...
> **The required inputs to compute N, σ, MDE, and a ≥80% power analysis are available for the window 2022-08-01 → 2026-05-04 (194 events, 12 clusters).** The power analysis has since been run ([[HYP-PA-0001_POWER]]): pooled MDE ≈1.3%/event but cluster-limited to ~5% — **HYP-PA-0001 is owner-HELD pending more clusters.** Full 5-year coverage is not reached; 2021-H2, 2022-H1, and May-2024 remain documented gaps, closable only by further retrieval — **not** by imputation. Primary (IDX) verification remains **0** (Cloudflare-blocked, §5); a manual download step is required before any capital-relevant use.
>
