...
- [ ] Every P0 task merged with evidence bundle (`docs/evidence/P0/<task-id>/`) — 13/16 merged (P0.E1.S1.T1, P0.E1.S1.T2, P0.E1.S2.T1, P0.E1.S2.T2, P0.E1.S2.T3, P0.E1.S2.T4, P0.E1.S2.T5, P0.E1.S2.T6, P0.E2.S1.T1, P0.E2.S1.T2, P0.E2.S2.T1, P0.E2.S2.T2, P0.E2.S3.T1). P0.E1, P0.E2.S1, and P0.E2.S2 fully closed. P0.E2.S3.T1 (`/metrics` `idx_market_risk_score` column-name fix, `[L-1]`) merged — `docs/evidence/P0/P0.E2.S3.T1/`. Remaining 3 are P0.E2.S3.T2–T4. Checkbox stays unticked until all 16 land.
