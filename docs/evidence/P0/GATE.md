...
- [ ] Every P0 task merged with evidence bundle (`docs/evidence/P0/<task-id>/`) — 15/16 merged (P0.E1.S1.T1, P0.E1.S1.T2, P0.E1.S2.T1, P0.E1.S2.T2, P0.E1.S2.T3, P0.E1.S2.T4, P0.E1.S2.T5, P0.E1.S2.T6, P0.E2.S1.T1, P0.E2.S1.T2, P0.E2.S2.T1, P0.E2.S2.T2, P0.E2.S3.T1, P0.E2.S3.T2, P0.E2.S3.T3). P0.E1, P0.E2.S1, and P0.E2.S2 fully closed. P0.E2.S3.T3 (calendar-year-missing December alarm, `[L-5]`) merged — `docs/evidence/P0/P0.E2.S3.T3/`. Remaining 1 is P0.E2.S3.T4 — the last Phase 0 task. Checkbox stays unticked until all 16 land.
