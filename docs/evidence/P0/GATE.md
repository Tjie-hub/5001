...
- [ ] Every P0 task merged with evidence bundle (`docs/evidence/P0/<task-id>/`) — 6/16 merged (P0.E1.S1.T1, P0.E1.S1.T2, P0.E1.S2.T1, P0.E1.S2.T2, P0.E1.S2.T3, P0.E1.S2.T4). Denominator stands at 16: `P0.E1.S2.T5` (T3's payoff task, DEBT-001/DEBT-002) and `P0.E1.S2.T6` (T4's own new finding, DEBT-003 — `run_vpin_backfill`) both added via PLAN-001 §18 change control, neither started. Checkbox stays unticked until all 16 land.
