...
> ⚠️ **SUPERSEDED 2026-07-14 — ARCHIVED FOR HISTORY ONLY.** The baseline of record
> is now **v3** at `docs/RESEARCH_MASTER_PLAN.md` (ratified & frozen 2026-07-14).
> v3 keeps this document's eight-phase roadmap unchanged and layers four
> adversarial-review resolutions on top (see v3 §3). Do not implement against this
> file — read v3.

# 🔒 ARCHITECTURE BASELINE — FROZEN (superseded by v3)
