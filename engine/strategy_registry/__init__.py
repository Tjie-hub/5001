...
Usage:
    ...
    from engine.strategy_registry.registry import register_strategy
    ...
    # Get all strategies
    from engine.strategy_registry.registry import STRATEGY_FUNCS
    for name, func in STRATEGY_FUNCS.items():
        ...

    # Use backtest utilities
    from engine.strategy_registry.backtest import Trade, run_strategy, lot_size
"""
