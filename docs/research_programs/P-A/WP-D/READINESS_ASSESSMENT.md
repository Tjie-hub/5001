...
|---|---|---|
| **(a) Count N** | ✅ **Yes, for the covered window** | 188 ticker-events (94 ADD / 94 DELETE); 172 distinct economic events; window 2022-08 → 2026-05; sub-counts by index/direction in [[COVERAGE_REPORT]]. Directly countable from `reconstitution_events.csv`. |
...
2. **A coverage-sufficiency judgment.** The verified window is **~3.75 years / 188 events (2022-08 → 2026-05)**, not the full ~5 years. This is enough to *compute* N/σ/MDE/power, but whether it is enough to *register on* — versus first closing the residual gaps (2021-H2, 2022-H1, the two May evals) for more history — is a CRO call.
...
> **The required inputs to compute N, σ, MDE, and a ≥80% power analysis are now available for the window 2022-08-01 → 2026-05-04 (188 events).** They are **not** available for the full 5-year window; 2021-H2, 2022-H1, and the May-2024/May-2025 minor-evaluations remain documented gaps, closable only by further retrieval — **not** by imputation. Primary (IDX) verification remains **0** — automated access is Cloudflare-blocked ([[COVERAGE_REPORT]] §5); a manual download step is required before any capital-relevant use.
>
