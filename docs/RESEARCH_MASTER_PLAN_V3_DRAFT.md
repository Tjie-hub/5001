# Research Master Plan — v3 (DRAFT)

# 📝 DRAFT — PENDING OWNER RATIFICATION

**Status:** DRAFT — not frozen. Supersedes `docs/RESEARCH_MASTER_PLAN.md` (v2,
frozen 2026-07-12) **only upon explicit owner ratification** per v2 §13 change
control. Until ratified, v2 remains the baseline of record.
**Drafted:** 2026-07-14
...
- [ ] Ratify §3.1 family-scoping + effective-N design (incl. invariant #12).
- [ ] Ratify forward-test rule v2 defaults: `N_r ≥ 8`, `expectancy_r ≥ +0.25%/trade` (§3.2b) — or set different values *before* first use.
- [ ] Confirm NR7 grandfather clause (§3.2e).
- [ ] Ratify R-5 elevation to Phase F blocker (§3.3c).
- [ ] Approve Phase E plan Task 11 (receipt-bound `set_status`) for execution.
- [ ] On ratification: mark this file FROZEN v3, retire v2 to `docs/archive/`, and record the amendment date.

*End of Research Master Plan v3 — DRAFT pending ratification.*
