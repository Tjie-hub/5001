...
- [ ] Every P0 task merged with evidence bundle (`docs/evidence/P0/<task-id>/`) — 14/16 merged (P0.E1.S1.T1, P0.E1.S1.T2, P0.E1.S2.T1, P0.E1.S2.T2, P0.E1.S2.T3, P0.E1.S2.T4, P0.E1.S2.T5, P0.E1.S2.T6, P0.E2.S1.T1, P0.E2.S1.T2, P0.E2.S2.T1, P0.E2.S2.T2, P0.E2.S3.T1, P0.E2.S3.T2). P0.E1, P0.E2.S1, and P0.E2.S2 fully closed. P0.E2.S3.T2 (dead `stockbit_fetcher._parse_args` deleted, `[L-3]`) merged — `docs/evidence/P0/P0.E2.S3.T2/`. Remaining 2 are P0.E2.S3.T3–T4. Checkbox stays unticked until all 16 land.
